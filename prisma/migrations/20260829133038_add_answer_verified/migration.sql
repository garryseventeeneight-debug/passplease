...
INSERT INTO "new_Question" ("createdAt", "difficulty", "explanation", "id", "isAiGenerated", "isTestFixture", "questionText", "source", "sourcePaper", "sourceUrl", "sourceYear", "subjectId", "subtopicId", "syllabusOutcome", "topicId", "type") SELECT "createdAt", "difficulty", "explanation", "id", "isAiGenerated", "isTestFixture", "questionText", "source", "sourcePaper", "sourceUrl", "sourceYear", "subjectId", "subtopicId", "syllabusOutcome", "topicId", "type" FROM "Question";
DROP TABLE "Question";
