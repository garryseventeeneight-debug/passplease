...
INSERT INTO "new_LearnChunk" ("body", "checkText", "createdAt", "heading", "id", "order", "subtopicId", "topicId") SELECT "body", "checkText", "createdAt", "heading", "id", "order", "subtopicId", "topicId" FROM "LearnChunk";
